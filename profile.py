...
node_client.addService(pg.Execute('/bin/sh','/usr/bin/sudo /usr/bin/git clone https://github.com/aydini/Multipath-Wireless-Link-Traces.git /local/repository; /usr/bin/sudo /bin/bash /local/repository/CloudLab/client.sh'))
...
node_emulator2.addService(pg.Execute('/bin/sh','/usr/bin/sudo /usr/bin/git clone https://github.com/aydini/Multipath-Wireless-Link-Traces.git /local/repository; /usr/bin/sudo /bin/bash /local/repository/CloudLab/emulator2.sh'))
...
node_emulator1.addService(pg.Execute('/bin/sh','/usr/bin/sudo /usr/bin/git clone https://github.com/aydini/Multipath-Wireless-Link-Traces.git /local/repository; /usr/bin/sudo /bin/bash /local/repository/CloudLab/emulator1.sh'))
...
node_server.addService(pg.Execute('/bin/sh','/usr/bin/sudo /usr/bin/git clone https://github.com/aydini/Multipath-Wireless-Link-Traces.git /local/repository; /usr/bin/sudo /bin/bash /local/repository/CloudLab/server.sh'))
...
node_router1.addService(pg.Execute('/bin/sh','/usr/bin/sudo /usr/bin/git clone https://github.com/aydini/Multipath-Wireless-Link-Traces.git /local/repository; /usr/bin/sudo /bin/bash /local/repository/CloudLab/router1.sh'))
...
node_router2.addService(pg.Execute('/bin/sh','/usr/bin/sudo /usr/bin/git clone https://github.com/aydini/Multipath-Wireless-Link-Traces.git /local/repository; /usr/bin/sudo /bin/bash /local/repository/CloudLab/router2.sh'))
